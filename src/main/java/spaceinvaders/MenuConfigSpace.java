...
public class MenuConfigSpace implements ActionListener {
    ...
    // ── Skins ─────────────────────────────────────────────────────────────────
    private JComboBox<String> skinNave;
    private JComboBox<String> skinInvasores;
    private JComboBox<String> skinProyectil;
    ...
    private static final Color COLOR_SECTION = new Color(150, 200, 255); // acento azul
    ...
    public MenuConfigSpace() {
        ...
        skinNave           = crearCombo(new String[]{"Original", "Azul", "Roja"});
        skinInvasores      = crearCombo(new String[]{"Original", "Robots", "Fantasmas"});
        skinProyectil      = crearCombo(new String[]{"Original", "Laser", "Bola"});
        ...
        // ── Layout en dos columnas con scroll ─────────────────────────────────
        ...
        // — Skins —
        espacio(config, gbc, f++);
        seccion(config, gbc, "── Skins ──", f++);
        label(config, gbc, "Nave jugador:", 0, f);   comp(config, gbc, skinNave,      1, f++);
        label(config, gbc, "Invasores:",    0, f);   comp(config, gbc, skinInvasores, 1, f++);
        label(config, gbc, "Proyectil:",    0, f);   comp(config, gbc, skinProyectil, 1, f++);
        ...
        // ── Scroll por si la ventana es chica ────────────────────────────────
    ...
    private void cargarConfiguracion() {
        ...
        seleccionar(skinNave,           p.getProperty("skinNave",           "Original"));
        seleccionar(skinInvasores,      p.getProperty("skinInvasores",      "Original"));
        seleccionar(skinProyectil,      p.getProperty("skinProyectil",      "Original"));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == reset) {
            ...
            skinNave.setSelectedIndex(0);
            skinInvasores.setSelectedIndex(0);
            skinProyectil.setSelectedIndex(0);
        ...
        p.setProperty("skinNave",          (String) skinNave.getSelectedItem());
        p.setProperty("skinInvasores",     (String) skinInvasores.getSelectedItem());
        p.setProperty("skinProyectil",     (String) skinProyectil.getSelectedItem());
